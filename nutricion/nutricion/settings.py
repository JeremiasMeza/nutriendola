...
SECRET_KEY = 'django-insecure-46!s9z%*%bd)ys=6u@v)(ho1&5c5#$p!it*7l71!r(fwm&qr58'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'nutricion',                    # Nombre de tu base de datos MySQL
        'USER': 'root',             # Usuario de la base de datos MySQL
        'PASSWORD': '',      # Contraseña del usuario MySQL
        'HOST': 'localhost',                    # El host (generalmente localhost)
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Asegúrate de que esto sea correcto
]
